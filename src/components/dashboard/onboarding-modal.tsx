      ...
      <DialogContent className="max-w-md p-0 overflow-hidden">
        {step === 0 && (
          <div className="flex flex-col items-center text-center px-8 py-10">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#E97E1C]/10 mb-6">
              <Rocket className="h-7 w-7 text-[#E97E1C]" />
            </div>
            <h2 className="text-xl font-semibold text-[#1a1a1a] mb-2">
              Willkommen bei Solarheld
            </h2>
            ...
            <Button
              className="w-full bg-[#E97E1C] hover:bg-[#E97E1C]/90"
              onClick={() => setStep(1)}
            >
              Los geht&apos;s
        ...
        {step === 1 && (
          <div className="flex flex-col items-center text-center px-8 py-10">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#E97E1C]/10 mb-6">
              <Sparkles className="h-7 w-7 text-[#E97E1C]" />
            </div>
            <h2 className="text-xl font-semibold text-[#1a1a1a] mb-2">
              Ihr erster Angebotsraum
            </h2>
            <p className="text-sm text-[#6b7280] leading-relaxed mb-3">
              Mit Solarheld erstellen Sie individuelle Angebotsräume für
              Ihre Kunden. So funktioniert es:
            </p>
            <ul className="text-sm text-[#6b7280] text-left space-y-2 mb-8 w-full">
              <li className="flex items-start gap-2">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#E97E1C]/10 text-[10px] font-semibold text-[#E97E1C] mt-0.5">
                  1
                </span>
        ...
        {step === 2 && (
          <div className="flex flex-col items-center text-center px-8 py-10">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#E97E1C]/10 mb-6">
              <CheckCircle2 className="h-7 w-7 text-[#E97E1C]" />
            </div>
            <h2 className="text-xl font-semibold text-[#1a1a1a] mb-2">
              Alles bereit!
            </h2>
