      ...
      <DialogContent className="max-w-md p-0 overflow-hidden">
        {step === 0 && (
          <div className="flex flex-col items-center text-center px-8 py-10">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-brand-500/10 mb-6">
        ...
        {step === 1 && (
          <div className="flex flex-col items-center text-center px-8 py-10">
            ...
            <ul className="text-sm text-fg-muted text-left space-y-2 mb-8 w-full">
              <li className="flex items-start gap-2">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-brand-500/10 text-[10px] font-semibold text-brand-500 mt-0.5">
                  1
                </span>
